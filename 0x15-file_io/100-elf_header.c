...
/**
 * print_magic - Magic numbers of an ELF header.
 * @e_ident: Array containing the ELF magic numbers.
 *
...
/**
 * print_osabi - Prints ELF header os/ab
 * @e_ident: A pointer to an array containing the ELF version.
 */
void print_osabi(unsigned char *e_ident)
{
...
/**
 * main - Information contained in ELF header at the start of an ELF file.
 * @argc: Argument count
 * @argv: Argument vector
 *
 * Return: 0 on success.
 *
 * Description: If the the function fails - exit code 98.
 */
